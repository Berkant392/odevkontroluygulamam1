                                ...
                                <div key={topic.id} className="flex flex-col group/topic">
                                    <div className="flex items-start gap-4 hover-lift">
                                        ...
                                        <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-2">
                                            ...
                                            {isTeacherMode && (
                                                <button onClick={() => deleteTopic(topic.id)} className="opacity-0 group-hover/topic:opacity-100 p-2 text-slate-300 hover:text-errorRed transition-all">
                                                    <Trash2 size={20}/>
                                                </button>
                                            )}
                                        </div>
                                        ...
                                        {topic.subTopics?.map(sub => (
                                            <div key={sub.id} className="flex items-center gap-3 group/sub hover-lift">
                                                ...
                                                <div className="flex-1 flex items-center justify-between">
                                                    ...
                                                    {isTeacherMode && (
                                                        <button onClick={() => deleteSubTopic(topic.id, sub.id)} className="opacity-0 group-hover/sub:opacity-100 p-1.5 text-slate-300 hover:text-errorRed transition-all">
                                                            <Trash2 size={16}/>
                                                        </button>
                                                    )}
                                                </div>
