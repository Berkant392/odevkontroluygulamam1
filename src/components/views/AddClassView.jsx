                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border-2 border-slate-200 rounded-2xl p-4 font-bold text-slate-700 outline-none focus:border-primary transition-colors"
                            value={className}
                    ...
                    <button
                        ...
                        className="w-full bg-primary text-white rounded-2xl p-4 font-black tracking-wide flex items-center justify-center gap-2 hover:bg-purple-700 transition-colors shadow-glow disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        <Plus size={20} />
                        SINIFI OLUŞTUR
                    </button>
