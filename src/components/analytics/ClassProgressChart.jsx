...
const ClassProgressChart = ({ classes }) => {
    ...
    return (
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm w-full h-[300px] mt-6 flex flex-col">
            <h3 className="text-sm font-black text-slate-600 mb-4 uppercase tracking-widest pl-2 border-l-4 border-brandPurple">
                Sınıf Genel Başarı Oranları
            </h3>
